...
<body>
		...
		<div class="app-container">
			...
			<div class="app-content app-sidebar-left">
				...
				<div class="app-heading app-heading-bordered app-heading-page">
					<div class="title">
						<h2>Manage Physical Verification Allocation</h2>
						<p>Schedule Physical Verification!</p>
					</div>
				</div>
				<div class="app-heading-container app-heading-bordered bottom">
					<ul class="breadcrumb">
						...
						<li class="active">Allocation Verification</li>
					</ul>
				</div>
				<!-- END PAGE HEADING -->
						...
						<div class="col-md-12">
							<div class="block">
								<div class="app-heading app-heading-small">
									<div class="title">
										<h2>Physical Verification Allotment</h2>
									</div>
								</div>
								<f:form action="insertVerification.htm" method="POST"
									modelAttribute="data">
									...
									<div class="btn-group bootstrap-select bs-select"
										...
										<f:select class="bs-select" tabindex="-98"
											path="staffMember.loanStaffId">
											<f:option value=""></f:option>
											<c:forEach items="${list }" var="v">
												<f:option value="${v.loanStaffId }">${v.loanStaffFirstName } ${v.loanStaffLastName }</f:option>
											</c:forEach>
										</f:select>
									</div>
									<div class="form-group">
										...
										<f:input class="form-control" data-validation="required"
											placeholder="Address" path="verificationAddress" />
										<f:hidden path="verificationId" />
									</div>
									<div class="form-group">
										<label>Date</label>
										<f:input class="mask_date form-control" data-validation="date"
											placeholder="yyyy-mm-dd" path="verificationDate" />
									</div>
									<div class="form-group">
										<label>Time</label>
										<f:input class="form-control" data-validation="time"
											placeholder="HH:mm" path="verificationTime" />
									</div>
									<div class="form-group margin-top-20">
										<button class="btn btn-default" type="submit">Allote</button>
									</div>
								</f:form>
							</div>
						</div>
	...
	<script type="text/javascript"
		src="admin/js/jquery.maskedinput.min.js"></script>	
