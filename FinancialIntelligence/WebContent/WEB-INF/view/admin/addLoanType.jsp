			...
			<div class="app-content app-sidebar-left">
				...
				<div class="app-heading app-heading-bordered app-heading-page">
					<div class="title">
						...
						<p>Manage variour loan categories!</p>
					</div>
				</div>
				<div class="app-heading-container app-heading-bordered bottom">
					<ul class="breadcrumb">
						<li><a href="index.jsp">Dashboard</a></li>
						<li><a href="index.jsp">Manage Loan Types</a></li>
						<li class="active">Add Loan Types</li>
					</ul>
				</div>
				<!-- END PAGE HEADING -->
						...
						<div class="col-md-12">
							<div class="block">
								<div class="app-heading app-heading-small">
									<div class="title">
										<h2>Add Loan Type</h2>
										<p>Add various loan types!</p>
									</div>
								</div>
								<f:form action="insertLoanType.htm" method="POST"
									modelAttribute="data">
									<div class="form-group">
										<label>Loan Type</label>
										<f:input class="form-control" data-validation="required"
											placeholder="Loan Type Name" path="loanTypeName" />
										<f:hidden path="loanTypeId"/>
									</div>
									<div class="form-group">
										<label>Description</label>
										<f:input class="form-control" data-validation="required"
											placeholder="Description" path="loanTypeDescription" />
									</div>
									<div class="form-group">
										<label>Dodument Details</label>
										<f:input class="form-control" data-validation="required"
											placeholder="Document Detail" path="loanTypeDocumentDetails" />
									</div>
									<div class="form-group">
										<label>Interest Rate</label>
										<f:input class="form-control" data-validation="required"
											placeholder="Interest Rate" path="loanTypeInterest" />
									</div>
