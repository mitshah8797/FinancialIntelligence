			...
			<div class="app-content app-sidebar-left">
				...
				<div class="app-heading app-heading-bordered app-heading-page">
					<div class="title">
						...
						<p>View various complaints here!</p>
					</div>
				</div>
				<div class="app-heading-container app-heading-bordered bottom">
					<ul class="breadcrumb">
						<li><a href="index.jsp">Dashboard</a></li>
						<li><a href="index.jsp">Manage Complaint</a></li>
						<li class="active">Comlaints</li>
					</ul>
				</div>
				<!-- END PAGE HEADING -->
							...
							<table
								...
								<tbody>
									<c:forEach items="${data}" var="v">
										<tr>
											<td><c:out value="${v.complaintId}"></c:out></td>
											<td><c:out value="${v.complaintSubject }"></c:out></td>
											<td><c:out value="${v.complaintDescription }"></c:out></td>
											<td><c:out value="${v.user.emailId }"></c:out></td>
											<td><form action="editComplaint.htm" method="post">
													<input type="hidden" value="${v.complaintId }" name="complaintId">
													<input type="hidden" value="${v.complaintSubject }" name="complaintSubject">
													<input type="hidden" value="${v.complaintDescription }"
														name="complaintDesc">
													<input type="hidden" value="${v.user.loginId }" name="userId">
													<button class="btn btn-default" type="submit">
														Edit</button>
												</form>
												<!--<form action="deleteComplaintCutomer.htm" method="POST">
													<input type="hidden" value="${v.complaintId }" name="complaintId">
