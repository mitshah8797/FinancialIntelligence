		...
		<div class="app-container">
			...
			<div class="app-content app-sidebar-left">
				...
				<div class="app-heading app-heading-bordered app-heading-page">
					<div class="title">
						<h2>Add your Feedbacks</h2>
						<p>Your feedbacks are important for us!</p>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								...
								<f:form action="addFeedback.htm" method="POST" modelAttribute="data"> 
									<div class="form-group">
										<label>Your Feedback</label> <f:input class="form-control"
											data-validation="required" path="feedbackDescription"/>
											<f:hidden path="feedbackId"/>
									</div>
									<div class="form-group margin-top-20">
										<button class="btn btn-default" type="submit">Give
											Feedback</button>
									</div>
								</f:form>
							</div>
