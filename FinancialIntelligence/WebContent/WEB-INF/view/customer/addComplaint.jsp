		...
		<div class="app-container">
			...
			<div class="app-content app-sidebar-left">
				...
				<div class="app-heading app-heading-bordered app-heading-page">
					<div class="title">
						<h2>Complaints</h2>
						<p>Add your concerned complaints. We'll try to fix that!</p>
					</div>
				</div>
						...
						<div class="col-md-12">
							<div class="block">
								<div class="app-heading app-heading-small">
									<div class="title">
										<h2>Add Comlaint</h2>
										<p>Add your compaint!</p>
									</div>
								</div>
								<f:form action="addComplaint.htm" method="POST"
									modelAttribute="data">
									<div class="form-group">
										<label>Complaint Subject</label>
										<f:input class="form-control" data-validation="required"
											placeholder="Complain Subject" path="complaintSubject" />
									</div>
									<div class="form-group">
										<label>Description</label>
										<f:input class="form-control" data-validation="required"
											placeholder="Description" path="complaintDescription" />
										<f:hidden path="user.loginId"/>
